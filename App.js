...
const allQuestions = [
  {
    ...
    options: [
      { text: 'Build a barricade out of canned beans', value: 'neonGravedigger' },
      ...
      { text: 'Meditate and accept the void', value: 'balloonNecromancer' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Organize a neighborhood defense grid', value: 'yodelMechanic' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: '“Whispers from the Ceiling Fan”', value: 'fogMechanic' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'A box of shared memories', value: 'bureaucracyGhoul' },
      { text: 'A bag of teeth and glitter', value: 'glitterButcher' },
      { text: 'A crystal that buzzes when stared at', value: 'fogMechanic' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: 'Assign it as logistics coordinator', value: 'bureaucracyGhoul' },
      { text: 'Offer emotional calibration training', value: 'squirrelTamer' },
  ...
  },
  {
    ...
    options: [
      { text: 'A keycard made from scrap metal', value: 'neonGravedigger' },
  ...
  },
  {
    ...
    options: [
      { text: 'A sword made of melted road signs', value: 'cockroachNegotiator' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Turn it into a floating community hub', value: 'skeletonBarista' },
      { text: 'Strip it for parts before anyone else can', value: 'glitterButcher' },
      { text: 'Sail it inland somehow, just to confuse people', value: 'lavaLifeguard' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'A one-eyed therapy pigeon', value: 'squirrelTamer' },
      { text: 'A hairless raccoon with trust issues', value: 'trashOracle' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Share a meal and learn their story', value: 'skeletonBarista' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Scavenging 101: Chaos Management', value: 'trashOracle' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'An eye that seems to follow you everywhere', value: 'lavaLifeguard' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Barter socks for canned spaghetti", value: "neonGravedigger" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Three raccoons in a trench coat flipping pancakes', value: 'trashOracle' },
      { text: 'A screaming cactus wearing sunglasses', value: 'duckPainter' },
      { text: 'An eldritch sandwich that whispers your debts', value: 'lavaLifeguard' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: 'Point at it and yell “same” until it goes away', value: 'cockroachNegotiator' },
      { text: 'Start selling tickets for the “End of the World Viewing Party”', value: 'travelAgentOfTerror' },
      { text: 'Challenge it to a rap battle… and lose', value: 'trashOracle' },
      { text: 'Offer it a sandwich as a peace treaty', value: 'lavaLifeguard' },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Ride everything at full speed', value: 'screamerScout' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Build a sock fort', value: 'molotovMixologist' },
      { text: 'Wear them all at once for enlightenment', value: 'fogMechanic' },
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Listen for cosmic messages', value: 'lavaLifeguard' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Bow respectfully', value: 'cyborgCellist' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Share the loot with allies', value: 'yodelMechanic' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Ask cryptic questions', value: 'balloonNecromancer' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Jump off it recklessly', value: 'screamerScout' },
  ...
  },
  {
    ...
    image: {
      uri: "https://raw.githubusercontent.com/dboss212121/ApocalypseQuiz/main/assets/images/giantduck.png",
      alt: "A towering duck with glowing eyes and a suspiciously regal aura"
    },
    options: [
      { text: "Declare it your new president", value: "duckPainter" },
      { text: "Offer it breadcrumbs and existential riddles", value: "skeletonBarista" },
      { text: "Challenge it to a staring contest", value: "hamsterWarlord" },
      { text: "Ask if it’s the final boss or just lost", value: "cyborgCellist" }
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Feed it spare snacks', value: 'kaleChampion' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Use it to help friends', value: 'yodelMechanic' },
  ...
  },
  {
    ...
    options: [
      { text: 'Distribute it fairly', value: 'neonGravedigger' },
      { text: 'Offer it to hungry survivors', value: 'kaleChampion' },
  ...
  },
  {
    ...
    image: {
      uri: "https://raw.githubusercontent.com/dboss212121/ApocalypseQuiz/main/assets/images/teddytunnel.png",
    ...
    options: [
      ...
      { text: 'Meditate inside it', value: 'cyborgCellist' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Cheer it up with gifts', value: 'skeletonBarista' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Clean the camp efficiently', value: 'kaleChampion' },
      { text: 'Swing it wildly', value: 'molotovMixologist' },
      { text: 'Ask it to tell stories', value: 'lavaLifeguard' },
    ]
  },
  {
    ...
    options: [
      { text: 'Listen carefully', value: 'duckPainter' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Share it with the squad', value: 'kaleChampion' },
      { text: 'Slip on it dramatically', value: 'hamsterWarlord' },
      { text: 'Meditate while balancing on it', value: 'lavaLifeguard' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Split the glitter bill with your party', value: 'skeletonBarista' },
  ...
  },
  {
    ...
    options: [
      { text: 'Conduct a formal roommate interview', value: 'yodelMechanic' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Pass out free samples to friends', value: 'kaleChampion' },
      { text: 'Bite the tacos before customers can order', value: 'gnocchiNomad' },
      { text: 'Ask if the salsa is made of moonlight and goats', value: 'fogMechanic' },
    ]
  },
  {
    ...
    options: [
      { text: 'Lead the discussion on “Brains: A Memoir”', value: 'cockroachNegotiator' },
      ...
      { text: 'Insist the only valid book is one written by worms', value: 'fogMechanic' },
    ]
  },
  {
    ...
    options: [
      { text: 'Offer to be the co-host and manage scheduling', value: 'cockroachNegotiator' },
      ...
      { text: 'Ask if the podcast only streams at midnight', value: 'balloonNecromancer' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Ask if the beats were recorded under the moon with kelp', value: 'balloonNecromancer' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Eat the clipboard before any questions are asked', value: 'trashOracle' },
      { text: 'Ask if destruction counts as “strongly agree” or “neutral”', value: 'fogMechanic' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Translate their dairy hymns for outsiders', value: 'squirrelTamer' },
      { text: 'Gnaw on the elders during negotiations', value: 'gnocchiNomad' },
      { text: 'Ask if lactose intolerance is considered heresy', value: 'fogMechanic' },
    ]
  },
  {
    ...
    options: [
      ...
      { text: 'Invite the ghost to sit while you applaud respectfully', value: 'squirrelTamer' },
      { text: 'Break the chair further and start a midnight wrestling match with shadows', value: 'hamsterWarlord' },
      { text: 'Ask the chair if it remembers its tree-life before death', value: 'balloonNecromancer' },
    ]
  },
  {
    question: "IN THE DESERT, YOU FIND A TREASURE CHEST HALF-BURIED IN DUNES. IT HUMS A COUNTRY SONG. YOU:",
    image: {
      uri: "https://raw.githubusercontent.com/dboss212121/ApocalypseQuiz/main/assets/images/treasurechest.png",
  ...
  },
  {
    ...
    options: [
      { text: "Insert a coupon for ‘One Free Existential Crisis’ and wait for it to vend enlightenment", "value": "fogMechanic" },
      { text: "Challenge the bomb to a staring contest and lose dramatically", "value": "lavaLifeguard" },
      { text: "Recite the alphabet backwards while juggling expired batteries", "value": "yodelMechanic" },
      { text: "Offer it a friendship bracelet made of spaghetti and hope for detente", "value": "balloonNecromancer" }
    ]
  }
...
const roles = {
  ...
  screamerScout: {
    ...
    image: { uri: "https://raw.githubusercontent.com/dboss212121/ApocalypseQuiz/main/assets/images/screamerScout.png" },
  },
  bureaucracyGhoul: {
...
const SecretProgressBar = ({ secretStage, onComplete }) => {
  const [progress, setProgress] = useState(0);

  const handlePress = () => {
    if (secretStage !== 3) return; // Only interactive in Stage 3

    const newVal = Math.min(100, progress + 20);
    setProgress(newVal);

    if (newVal >= 100 && onComplete) {
      onComplete();
    }
  };
  ...
  return (
    <TouchableOpacity
      activeOpacity={secretStage === 3 ? 0.7 : 1}
      onPress={handlePress}
      style={styles.secretProgressContainer}
    >
      <View style={styles.secretProgressBackground}>
        <View style={[styles.secretProgressFill, { width: `${progress}%` }]} />
      </View>
    </TouchableOpacity>
  );
};
...
export default function App() {
  ...
  const [secretStartIndex, setSecretStartIndex] = useState(null);
  const [forbiddenShown, setForbiddenShown] = useState(false);
  const previousModeRef = useRef(null);

  const runGlitchEffect = (flicker, jitterX) => {
    Animated.sequence([
      Animated.timing(flicker, { toValue: 0.2, duration: 60, useNativeDriver: true }),
      Animated.timing(flicker, { toValue: 1, duration: 60, useNativeDriver: true }),
    ]).start();

    Animated.sequence([
      Animated.timing(jitterX, { toValue: -15, duration: 40, useNativeDriver: true }),
      Animated.timing(jitterX, { toValue: 15, duration: 40, useNativeDriver: true }),
      Animated.timing(jitterX, { toValue: 0, duration: 40, useNativeDriver: true }),
    ]).start();
  };

function getAnswersForQuestion(index) {
  if (!quizQuestions[index] || !quizQuestions[index].options) {
    return [];
  }

  const base = quizQuestions[index].options;

  // FIRST forbidden answer appears on Q3, Q4, or Q5
  if (!forbiddenShown && secretTriggerCount === 0 && [2, 3, 4].includes(index)) {
    // Pick a random index to replace
    const randomIndex = Math.floor(Math.random() * base.length);

    // Replace that option with the forbidden one
    const replaced = [...base];
    replaced[randomIndex] = {
      text: "Test answer, ignore",
      isSecret: true
    };
  ...
  // If sequence has started, inject the next two steps
  if (secretStartIndex !== null) {
    const step = index - secretStartIndex;

    if (step === 1 && secretTriggerCount === 1) {
      const replaced = [...base];
      const randomIndex = Math.floor(Math.random() * base.length);
      replaced[randomIndex] = {
        text: "Ignored. Failure detected. Do not press again.",
        isSecret: true
      };
      return replaced;
    }

    if (step === 2 && secretTriggerCount === 2) {
      const replaced = [...base];
      const randomIndex = Math.floor(Math.random() * base.length);
      replaced[randomIndex] = {
        text: "Subject repeatedly failing instructions. Disabling image click protocol.",
        isSecret: true
      };
      return replaced;
    }
  ...
  useEffect(() => {
    if (mode === "secret") {
      ...
      Animated.parallel([
        Animated.sequence([
          Animated.timing(flicker, { toValue: 0.3, duration: 70, useNativeDriver: false }),
          Animated.timing(flicker, { toValue: 1, duration: 100, useNativeDriver: false }),
          Animated.timing(flicker, { toValue: 0.6, duration: 60, useNativeDriver: false }),
          Animated.timing(flicker, { toValue: 1, duration: 120, useNativeDriver: false }),
        ]),
        Animated.sequence([
          Animated.timing(jitterX, { toValue: -10, duration: 80, useNativeDriver: false }),
          Animated.timing(jitterX, { toValue: 12, duration: 100, useNativeDriver: false }),
          Animated.timing(jitterX, { toValue: -6, duration: 70, useNativeDriver: false }),
          Animated.timing(jitterX, { toValue: 0, duration: 120, useNativeDriver: false }),
        ]),
      ]).start();

      // Fade in overlay text
      Animated.sequence([
        Animated.timing(overlayOpacity, { toValue: 1, duration: 500, useNativeDriver: false }),
        Animated.delay(600),
        Animated.timing(overlayOpacity, { toValue: 0, duration: 500, useNativeDriver: false }),
        Animated.timing(screenOpacity, { toValue: 1, duration: 600, useNativeDriver: false }),
      ]).start(() => {
  ...
  //For Mobile Music Play on First Click
  async function playSecretResultMusic() {
    if (isMuted) return;

    if (secretResultSound) {
      const status = await secretResultSound.getStatusAsync();
      if (status.isLoaded && !status.isPlaying) {
        await secretResultSound.playAsync();
      }
      return;
    }

    const { sound } = await Audio.Sound.createAsync(
      require('./assets/music/TLA.mp3'),
      { isLooping: true }
    );
  ...
  const toggleMute = async () => {
    ...
    if (!newMuted) {
      // 🔥 Stop and unload all sounds before re-initializing
      const all = [
        { sound: titleSound, setter: setTitleSound },
        { sound: quizSound, setter: setQuizSound },
        { sound: creditsSound, setter: setCreditsSound },
        { sound: secretSound, setter: setSecretSound },
        { sound: secretResultSound, setter: setSecretResultSound },
      ];

      for (let { sound, setter } of all) {
        if (sound) {
          try {
      ...
      // 🔁 Force re-evaluation of desired track
  ...
  async function playTitleMusic() {
    ...
    if (titleSound) {
      ...
      if (status.isLoaded && !status.isPlaying) {
        await titleSound.setVolumeAsync(1.0);
    ...
    await sound.setVolumeAsync(1.0); // 🔊 Respect mute state
    await sound.playAsync();
    setTitleSound(sound);
  }
  ...
  async function playQuizMusic() {
    ...
    if (quizSound) {
      const status = await quizSound.getStatusAsync();
      if (status.isLoaded && !status.isPlaying) {
        await quizSound.setVolumeAsync(1.0);
  ...
  async function playCreditsMusic() {
    ...
    if (creditsSound) {
      const status = await creditsSound.getStatusAsync();
      if (status.isLoaded && !status.isPlaying) {
        await creditsSound.setVolumeAsync(1.0);
        await creditsSound.playAsync();
      }
      return;
    }

    const { sound } = await Audio.Sound.createAsync(
      require('./assets/music/TLCKMD.mp3'),
      { isLooping: true }
    );
    await sound.setVolumeAsync(1.0);
    await sound.playAsync();
  ...
  //helper: play Secret music

  async function playSecretMusic() {
    if (isMuted) return;

    if (secretSound) {
      const status = await secretSound.getStatusAsync();
      if (status.isLoaded && !status.isPlaying) {
        await secretSound.setVolumeAsync(1.0);
        await secretSound.playAsync();
      }
      return;
    }

    const { sound } = await Audio.Sound.createAsync(
      require('./assets/music/TLTV.mp3'),
      { isLooping: true }
    );
    await sound.setVolumeAsync(1.0);
    await sound.playAsync();
  ...
  async function playSecretResultMusic() {
    ...
    if (secretResultSound) {
      const status = await secretResultSound.getStatusAsync();
      if (status.isLoaded && !status.isPlaying) {
        await secretResultSound.setVolumeAsync(1.0);
        await secretResultSound.playAsync();
      }
      return;
    }
  ...
  useEffect(() => {
    ...
    const handleMusic = async () => {
      ...
      // 🔇 If muted, skip everything
      if (isMuted) {
        lastTrackRef.current = null;
        return;
      }

      // 🔥 Stop/unload all tracks except the desired one
      const stopPromises = [];
      ...
      // 🎵 Play the correct track if not already started
      if (lastTrackRef.current === desiredTrack) return;
  ...
  const handleAnswer = (opt) => {
    ...
    // If they click a NORMAL answer while the forbidden hint is visible → mark it as ignored
    if (!opt.isSecret && secretTriggerCount === 0 && !forbiddenShown && [2, 3, 4].includes(currentQuestion)) {
      setForbiddenShown(true); // they ignored it
    }

    // If they click a NORMAL answer while sequence is active → reset
    if (!opt.isSecret && secretTriggerCount > 0) {
      setSecretTriggerCount(0);
      setSecretStartIndex(null);
      setForbiddenShown(true); // don't show again
    }

    // If they click a SECRET answer
    if (opt.isSecret) {
      const next = secretTriggerCount + 1;

      // First forbidden click → record where sequence started
      if (secretTriggerCount === 0) {
        setSecretStartIndex(currentQuestion);
        setForbiddenShown(true); // they interacted with it
      }

      setSecretTriggerCount(next);

      // Third forbidden click → glitch only
      if (next === 3) {
        runGlitchEffect(flicker, jitterX);

        // Reset sequence so quiz continues normally
        setSecretTriggerCount(0);
        setSecretStartIndex(null);
  ...
  if (!mode) {
    return (
      <View style={styles.fullScreenContainer}>
        ...
        <Text style={styles.resultText}>Adventure through the wasteland to discover how your choices determine your role after civilization has crumbled...</Text>
        <TouchableOpacity style={styles.button} onPress={() => setMode('basic')}><Text style={styles.buttonText}>BASIC ADVENTURE (10 Qs)</Text></TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => setMode('advanced')}><Text style={styles.buttonText}>ADVANCED ADVENTURE (20 Qs)</Text></TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => setMode('full')}><Text style={styles.buttonText}>FULL ADVENTURE (30 Qs)</Text></TouchableOpacity>
      ...
      <Animated.View style={{ flex: 1, opacity: flicker, transform: [{ translateX: jitterX }] }}>
        ...
        <Animated.View style={{ flex: 1, opacity: screenOpacity }}>
          <ScrollView contentContainerStyle={styles.fullScreenContainer}>
            ...
            <SecretProgressBar secretStage={1} />
  ...
  if (mode === "secret" && secretStage === 2) {
    ...
    return (
      <View style={styles.fullScreenContainer}>
        ...
        <SecretProgressBar secretStage={2} />
  ...
  return (
    <Animated.View style={{ flex: 1, opacity: flicker, transform: [{ translateX: jitterX }] }}>
      <ScrollView contentContainerStyle={styles.fullScreenContainer}>
        ...
        {getAnswersForQuestion(currentQuestion).map((opt, i) => (<TouchableOpacity
          key={i}
          style={[
            styles.button,
            opt.isSecret && styles.secretAnswerButton
          ]}
          onPress={() => handleAnswer(opt)}
        >
          <Text style={[
            styles.buttonText,
            opt.isSecret && styles.secretAnswerText
          ]}>
            {opt.text}
          </Text>
        </TouchableOpacity>
